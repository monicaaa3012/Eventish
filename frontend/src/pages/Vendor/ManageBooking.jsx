                      ...
                      {booking.status === "Booked" && (
                        <>
                          ...
                          {booking.paymentMethod && (
                            <div className="bg-green-50 rounded-xl p-3 mb-2 border border-green-200">
                              <p className="text-xs text-gray-600 mb-1">Payment Method:</p>
                              <p className="text-sm font-semibold text-green-700">
                                {booking.paymentMethod === "cash" ? "Cash Payment" : "Online Payment"}
                              </p>
                              <p className="text-xs text-green-600">
                                Status: {booking.paymentStatus === "completed" ? "Completed" : booking.paymentStatus === "pending" ? "Pending" : "Failed"}
                              </p>
                            </div>
                          )}
                          <button
