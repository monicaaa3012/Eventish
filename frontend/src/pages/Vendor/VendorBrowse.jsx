                  ...
                  <div className="p-6">
                    ...
                    <div className="flex space-x-2">
                      ...
                      {vendor.reviewCount > 0 && (
                        <button
                          onClick={() => navigate(`/vendors/${vendor._id}/reviews`)}
                          className="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-2 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center"
                          title={`View ${vendor.reviewCount} reviews`}
                        >
